...
### ✅ 개념
`ps` 명령어는 현재 **실행중인 프로세스를 확인**할 수 있는 명령어이다.
실행중인 프로세스의 pid, 사용자 등을 확인할 수 있다.
...
### ✅ 개념
`jobs` 명령어는 현재 **백그라운드에서 실행 중인 프로세스를 확인**할 수 있는 명령어이다.
...
### ✅ 개념
`kill` 명령어는 **프로세스를 종료** 시키는 명령어이다.
명령어 사용 시 반드시 **pid**를 입력해줘야 하며, 해당 pid에 해당하는 프로세스를 종료시킨다.
따라서, ps 등의 명령어를 통해 종료시킬 프로세스의 pid의 확인이 필요하다.
